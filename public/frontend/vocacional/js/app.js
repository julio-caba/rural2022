...
angular.module('testVApp')
    .controller("BarCtrl", function ($scope, $http, $timeout) {
         ...
         */
        $http.get("frontend/vocacional/data/questions.json").then(function (res) {
            console.info(res);
         ...
         */
        $http.get("frontend/vocacional/data/codigoscarreras.json").then(function (res) {
            console.info(res);
         ...
         */
        $http.get("frontend/vocacional/data/careers.json").then(function (res) {
            console.info(res);
         ...
         */
        $http.get("frontend/vocacional/data/personalities.json").then(function (res) {
            console.info(res);
